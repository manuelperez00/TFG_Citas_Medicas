...
public interface AppointmentRepository extends JpaRepository<Appointment, Integer> {
        ...
        @Query("SELECT a FROM Appointment a WHERE a.patient.id = :patientId AND a.doctor.specialty = :specialty AND a.status = 'OFFERED' ORDER BY a.offeredAt DESC LIMIT 1")
